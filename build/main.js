(() => {
  ...
  var Timeline = /* @__PURE__ */ function(_Animation) {
    ...
    _proto2.set = function set(targets2, vars, position) {
      vars.duration = 0;
      vars.parent = this;
    ...
    _proto2.staggerTo = function staggerTo(targets2, duration, vars, stagger, position, onCompleteAll, onCompleteAllParams) {
    ...
    _proto2.staggerFrom = function staggerFrom(targets2, duration, vars, stagger, position, onCompleteAll, onCompleteAllParams) {
      vars.runBackwards = 1;
      _inheritDefaults(vars).immediateRender = _isNotFalse(vars.immediateRender);
      return this.staggerTo(targets2, duration, vars, stagger, position, onCompleteAll, onCompleteAllParams);
    };
    _proto2.staggerFromTo = function staggerFromTo(targets2, duration, fromVars, toVars, stagger, position, onCompleteAll, onCompleteAllParams) {
      toVars.startAt = fromVars;
      _inheritDefaults(toVars).immediateRender = _isNotFalse(toVars.immediateRender);
      return this.staggerTo(targets2, duration, toVars, stagger, position, onCompleteAll, onCompleteAllParams);
    };
  ...
  var _addPropTween = function _addPropTween2(target, prop, start, end, index, targets2, modifier, stringFilter, funcParam) {
  ...
  var _initTween = function _initTween2(tween, time) {
    var vars = tween.vars, ease = vars.ease, startAt = vars.startAt, immediateRender = vars.immediateRender, lazy = vars.lazy, onUpdate = vars.onUpdate, onUpdateParams = vars.onUpdateParams, callbackScope = vars.callbackScope, runBackwards = vars.runBackwards, yoyoEase = vars.yoyoEase, keyframes = vars.keyframes, autoRevert = vars.autoRevert, dur = tween._dur, prevStartAt = tween._startAt, targets2 = tween._targets, parent = tween.parent, fullTargets = parent && parent.data === "nested" ? parent.parent._targets : targets2, autoOverwrite = tween._overwrite === "auto" && !_suppressOverwrites, tl2 = tween.timeline, cleanVars, i, p, pt, target, hasPriority, gsData, harness, plugin, ptLookup, index, harnessVars, overwritten;
  ...
  var Tween = /* @__PURE__ */ function(_Animation2) {
    ...
    function Tween2(targets2, vars, position, skipInherit) {
      ...
      _this3._targets = parsedTargets.length ? _harness(parsedTargets) : _warn("GSAP target " + targets2 + " not found. https://greensock.com", !_config.nullTargetWarn) || [];
      _this3._ptLookup = [];
    ...
    Tween2.set = function set(targets2, vars) {
      vars.duration = 0;
  ...
  var _gsap = {
    ...
    registerEffect: function registerEffect(_ref3) {
      ...
      _effects[name] = function(targets2, vars, tl2) {
        return effect(toArray(targets2), _setDefaults(vars || {}, defaults2), tl2);
      };
      if (extendTimeline) {
  ...
  var gsap = _gsap.registerPlugin({
    ...
    init: function init(target, vars, tween, index, targets2) {
      var p, pt;
      for (p in vars) {
        pt = this.add(target, "setAttribute", (target.getAttribute(p) || 0) + "", vars[p], index, targets2, 0, 0, p);
        pt && (pt.op = p);
        this._props.push(p);
      }
    }
  ...
  gsapWithCSS.to(observe, {
    scrollTrigger: {
      ...
      scrub: 1,
      onEnter: () => {
        gsapWithCSS.to(".main-nav__item-home", {
          opacity: 0.5
        });
        gsapWithCSS.to(".main-nav__item-me", {
          opacity: 1
        });
      },
      onLeave: () => {
  ...
  gsapWithCSS.to(observe, {
    scrollTrigger: {
      ...
      scrub: 1,
      onEnter: () => {
        gsapWithCSS.to(".main-nav__item-portfolio", {
          opacity: 1
        });
  ...
  gsapWithCSS.to(observe, {
    scrollTrigger: {
      ...
      scrub: 1,
      onEnter: () => {
        gsapWithCSS.to(".main-nav__item-hobbies", {
          opacity: 1
        });
      },
      onLeave: () => {
        ...
        gsapWithCSS.to(".main-nav__item-contact", {
          opacity: 1
        });
        gsapWithCSS.to(".main-nav__container", {
          color: "#333333",
